...
#define CURR_DERATE_PERCENT_FUN_EN								 STD_ON								/*derate percent function enable*/
...
#define CURR_GetChargeConditions(ch)								ERRHDL_GetChargeConditions(ch)			/*current module get ERRHDL module charge conditions interface*/
#define CURR_DERATE_PERCENT											80										/*Derating charging percentage*/
