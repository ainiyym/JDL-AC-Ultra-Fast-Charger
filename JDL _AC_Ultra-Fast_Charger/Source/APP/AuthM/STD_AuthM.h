...
typedef enum
{
    AUTHM_OPEN_SRC_NONE = 0,      /* INIT */
    AUTHM_OPEN_SRC_RFID,          /* RFID auth */
...
typedef enum
{
    AUTHM_CLOSE_SRC_NONE = 0,      /* init */
    AUTHM_CLOSE_SRC_RFID,          /* RFID close */
...
extern uint8_t AUTHM_GetAllowResAuthReqStatus(SysConnector_Num_Enum ch);
