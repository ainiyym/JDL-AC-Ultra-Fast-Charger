//******************************************************************************
//* File Name: Cloud_Protocol_Session.h
//* Project Name: JDL _AC_Ultra-Fast_Charger
//* Version: v1.0
//* Date: 2025-08-18 10:00:00
//* Author: JDLzhou
//* Description: Cloud Protocol module session layer header file
/*******************************************************************************/
#if !defined (__CLOUD_PROTOCOL_SESSION_H)
/* polyspace:begin<MISRA-C3:2.5:Not a defect:Justified> Normal. */
/* polyspace<MISRA-C3:21.1:Not a defect:Justified> Normal. */
#define __CLOUD_PROTOCOL_SESSION_H
/*******************************************************************************
...
// send frame status enumeration
typedef enum
{
    CLOUD_PROTOCOL_SEND_SUCCESS = 0,
    CLOUD_PROTOCOL_SEND_ERROR_MESSAGE_LENGTH_MISMATCH,
    CLOUD_PROTOCOL_SEND_ERROR_BUSY,
    CLOUD_PROTOCOL_SEND_ERROR_INVALID_PARAM
} Cloud_Protocol_Send_Status_T;

/*******************************************************************************
|    Typedef Definition
|******************************************************************************/
typedef void (*Cloud_Protocol_Recv_Cb)(void *arg, uint8_t *msg, uint16_t msglen);
typedef Cloud_Protocol_Send_Status_T (*Cloud_Protocol_Send_Cb)(void *arg, uint8_t *buff, uint16_t buffSize);
...
extern Cloud_Protocol_Send_Status_T Cloud_Protocol_CallSendFunc(uint8_t frame_type,
                                                               uint8_t *buffer,
                                                               uint16_t buffer_size);
