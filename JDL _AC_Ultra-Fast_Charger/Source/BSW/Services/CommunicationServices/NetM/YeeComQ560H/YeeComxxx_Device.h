...
typedef enum
{
    YEECOM_DEVICE_PARAM_USART_CFG,
    YEECOM_DEVICE_PARAM_DFI,
...
extern void YeeCom_SetDeviceInfo_dtuid(const char* dtuid);
...
extern void YeeCom_GetDeviceDTUID(char* dtuid);
