...
#define MODBUS_CH4_SND_BLOCK_FRAME_BUF_LEN   			(64 + 4)
#define MODBUS_CH4_RCV_PROC_FRAME_BUF_LEN   			(64)

#define MODBUS_CH5_SND_BLOCK_FRAME_BUF_LEN   			(64 + 4)
#define MODBUS_CH5_RCV_PROC_FRAME_BUF_LEN   			(64)
