...
#endif
#include <inttypes.h>
#define log_d(...)                     FAL_PRINTF("[D/FAL] %s:%d ", __func__, __LINE__);FAL_PRINTF(__VA_ARGS__);
...
#undef  log_e
#endif
#define log_e(...)                     FAL_PRINTF("[E/FAL] (%s:%d) ", __func__, __LINE__);FAL_PRINTF(__VA_ARGS__);

/* info level log */
#ifdef  log_i
#undef  log_i
#endif
#define log_i(...)                     FAL_PRINTF("[I/FAL] ");FAL_PRINTF(__VA_ARGS__);
