...
static const uint8_t test_data_oversize[300] = {0}; // 300�ֽڣ�����256������
...
static void init_test_context(test_context_t *context, MessageBuffer_Comm_System_t *comm_system) {
    ...
    context->timeout_ms = 10000; // 10���ܳ�ʱ
}
...
static test_result_t process_test_state(test_context_t *context)
{
    ...
    switch (context->current_state)
    {
        ...
        case TEST_STATE_SEND_OVERSIZE:
            MCAL_INFO("����״̬: SEND_OVERSIZE - ���Գ�����Ϣ���ͣ�Ӧʧ�ܣ�\r\n");
            result = MessageBuffer_SendMessage(context->comm_system, MESSAGE_BUFFER_TYPE_DATA,
        ...
        case TEST_STATE_SEND_ZERO_LENGTH:
            MCAL_INFO("����״̬: SEND_ZERO_LENGTH - �����㳤����Ϣ\r\n");
        ...
        case TEST_STATE_RECEIVE_TIMEOUT:
            MCAL_INFO("����״̬: RECEIVE_TIMEOUT - ���Խ��ճ�ʱ\r\n");
...
void print_datetime(const Mcal_RTC_DateTime_t* datetime)
{
    MCAL_INFO("Date: %04d-%02d-%02d, Time: %02d:%02d:%02d\r\n",
           datetime->Date.Year + 2000,  // ���������2λ������Ҫ����2000
           datetime->Date.Month,
           datetime->Date.Date,
           datetime->Time.Hours,
...
RTC_TestResult_t test_RTC_DateTime_SetGet(void)
{
    ...
    // ����һ���ض��Ĳ���ʱ��
    set_datetime.Date.Year = 23;    // 2023��
...
void run_all_rtc_tests(void)
{
    ...
    MCAL_INFO("�ܲ�����: %d, ͨ��: %d, ʧ��: %d\r\n", 
           total, passed, total - passed);
    
    if (passed == total) {
        MCAL_INFO("? ���в���ͨ����\r\n");
    } else {
        MCAL_INFO("? �в���ʧ�ܣ�����RTCӲ��������\r\n");
    }
...
{
    MCAL_INFO("RTCʱ��: %04d-%02d-%02d %02d:%02d:%02d\n",
...
// ����3: RTC_SecondsSetRtcDateTime
void test_RTC_SecondsSetRtcDateTime(void)
{
    MCAL_INFO("=== ���� RTC_SecondsSetRtcDateTime ===\n");
    
    uint32_t test_seconds = 1758706080; // ��������
...
// ����4: RTC_CP56Time2aSetRtcDateTime
void test_RTC_CP56Time2aSetRtcDateTime(void)
{
    MCAL_INFO("=== ���� RTC_CP56Time2aSetRtcDateTime ===\n");
    
    // ����CP56Time2a���ݣ�2024��1��15�� 14:30:25
...
void test_case_1_fixed_parameters(void)
{
    ...
    uint64_t timestamp = 1763432917443ULL; // ���ṩ�Ĺ̶�ʱ���
