...
|    Macro Definition
|******************************************************************************/
#define MESSAGE_BUFFER_MESSAGE_BUFFER_POOL_SIZE 2
#define MESSAGE_BUFFER_SIZE 800 // Max message size
#define MESSAGE_BUFFER_APP2_2_NET_MAX_SIZE      (MESSAGE_BUFFER_SIZE * 3)
...
typedef struct
{
    ...
    SemaphoreHandle_t send_mutex;           // send mutex
...
|******************************************************************************/
extern MessageBuffer_Comm_System_t* message_buffer_app_2_net; // APP ↔ NET, app1_to_app2_buf: APP → NET, app2_to_app1_buf: NET → APP
...
extern BaseType_t MessageBuffer_ReceiveMessage(MessageBuffer_Comm_System_t *comm, MessageBuffer_type_t *type, uint8_t **data_ptr , uint16_t *received_len, uint8_t dest, TickType_t timeout);
